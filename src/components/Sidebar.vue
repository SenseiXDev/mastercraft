<template>
	...
	<div class="deznav-scroll">
		<ul class="metismenu" id="menu">
			<!-- <li class="menu-title">Zowasel</li> -->
			...
			<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
				...
				<ul aria-expanded="false">
					<li><a href="/?page=addcustomer">Add Customer</a></li>
					<li><a href="/?page=addlead">Add A Lead</a></li>
					<li><a href="/?page=bulkcustomers">Add Customers(Bulk)</a></li>
					<li><a href="/?page=bulkleads">Add Leads(Bulk)</a></li>
					<li><a href="/?page=viewcustomers">View Customers</a></li>
					<li><a href="/?page=viewleads">View Leads</a></li>
					<li><a href="/?page=businesscertificates">Business Certificates</a></li>
					<li><a href="/?page=businessphotos">Business Photos</a></li>
					<li><a href="/?page=usersaccountnumbers">Users Account</a></li>
				</ul>
			</li>
			...
			<li>
				...
				<ul aria-expanded="false">
					<li><a href="/?page=addcrops">Create Crops</a></li>
					<li><a href="/?page=viewcrops">Market Listing</a></li>
					<li><a href="/?page=addcategory">Add Category</a></li>
					<li><a href="/?page=viewcategory">View Categories</a></li>
				</ul>
			</li>

			<li><a class="" href="/?page=negotiation" aria-expanded="false">
					<div class="menu-icon">
						<svg width="24" height="24" viewBox="0 0 24 24" fill="none"
							xmlns="http://www.w3.org/2000/svg">
							<g opacity="0.5">
					...
					<span class="nav-text">Negotiation</span>
				</a>
			...
			<li>
				<a class="has-arrow " href="/?page=reconciliation" aria-expanded="false">
					<div class="menu-icon">
			...
			<li>
				...
				<ul aria-expanded="false">
					<li><a href="/?page=purchaseorders">View Purchase Order</a></li>
					<li><a href="/?page=addpurchaseorder">Add Purchase Order</a></li>
			...
			<li>
				<a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
					...
					<span class="nav-text">Custom Doc</span>
				</a>
				<ul aria-expanded="false">

					<li><a href="/?page=custominvoice">Create Custom Doc</a></li>
					<li><a href="/?page=viewcustominvoice">View Custom Doc</a></li>
					<li><a href="/?page=docsettings">Create Doc Settings</a></li>
					<li><a href="/?page=viewdocsettings">View Doc Settings</a></li>
				</ul>
			</li>
			...
			<li>
				...
				<ul aria-expanded="false">
					...
					<li><a href="/?page=adminaccountnumbers">Admin Accounts</a></li>
					<li><a href="/?page=viewpayments">Payments</a></li>
				</ul>
			</li>
